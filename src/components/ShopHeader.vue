<template>
 <div class="shop-header">
    ...
    <div class="shop-content"  @click="isShow=!isShow">
    ...
    <div class="shop-header-discounts"  @click="isShowDiscounts=!isShowDiscounts">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports?info.supports[0].type:0]">
          <span class="content-tag">
      ...
      <div class="discounts-right" > 
        {{info.supports?info.supports.length:''}}个优惠
      </div>
    </div>
    ...
    <div class="shop-brief-modal" v-show="isShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer"  @click="isShow=!isShow">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover"  @click="isShow=!isShow"></div>
    </div>
      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="supportClasses[item.type]" v-for="(item, index) in info.supports" :key="index">
            <span class="content-tag">
              <span class="mini-tag" :class="supportClasses[item.type]">{{item.name}}</span>
            </span>
            <span class="activity-content">{{item.content}}</span>
          </li>
        </ul>
        <div class="activity-sheet-close" >
          <span class="iconfont icon-close"  @click="isShowDiscounts=!isShowDiscounts"></span>
        </div>
      </div>
      <div class="activity-sheet-cover"  @click="isShowDiscounts=!isShowDiscounts"></div>
    </div>
  </div>
</template>
